	...
	public function get_settings( $current_section = '' ) {
		...
		if( $current_section == '' ) {
			...
			$options = apply_filters( 'woocommerce_giftcard_settings', array(
				...
				array(
					'title'         => __( 'One Time Use Cards?',  'rpgiftcards'  ),
					'desc'          => __( 'Select this if you want cards to be disabled after first use.',  'rpgiftcards'  ),
				...
				array(
					'title'         => __( 'Disable Coupons',  'rpgiftcards'  ),
					'desc'          => __( 'Disable coupons when purchaseing a gift card.',  'rpgiftcards'  ),
				...
				array(
					'name'     => __( 'Address', 'rpgiftcards' ),
					'desc'     => __( 'This will change the placeholder field for the address field.', 'rpgiftcards' ),
				...
				array(
					'name'     => __( 'Reload Gift Card', 'rpgiftcards' ),
					'desc'     => __( 'This will change the placeholder field for the reloading option.', 'rpgiftcards' ),
				...
				array(
					'name'     => __( 'Gift Card Button Text', 'rpgiftcards' ),
